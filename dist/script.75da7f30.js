...
var doggos = document.querySelector(".doggos");
...
var divStyler = (0, _popmotion.styler)(document.querySelector(".box"));
(0, _popmotion.tween)({
  from: 0,
  to: {
    x: 300,
